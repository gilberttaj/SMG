...
<div id='result-pc-content' class='flex flex-col gap-[10px] result-content-vh'>
    <!-- <div class='absolute w-[64px] h-[32px] right-[40%] top-[80px]'>
        <img src=' <?= site_url('/wp-content/themes/smg') ?>/assets/images/Group 7@2x.png' class='w-full h-full' onclick="slideLeftRes()"/>
    </div>
    <div class='absolute w-[64px] h-[32px] right-[40%] bottom-[0]'>
        <img src=' <?= site_url('/wp-content/themes/smg') ?>/assets/images/Group 6@2x.png' class='w-full h-full' onclick="slideRightRes()"/>
    </div> -->
