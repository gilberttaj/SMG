<?php /* Template Name: Team 03 Template */ ?>
<?php get_header(); ?>
...
<div class="min-[751px]:w-[52.5%] min-[751px]:mx-auto mt-4 max-[750px]:px-5">
    <p class="text-[12px] noto-sans leading-[18px] tracking-[3px] text-[#959595] max-[750px]:text-[18px] max-[750px]:leading-[27px]"><a href="<?= site_url()?>">ホーム</a>　><a href="<?= site_url('/team-01')?>">選手・チーム紹介</a>　>陸上競技（混成競技）大玉華鈴選手</p>
</div>
...
<div class="min-[751px]:mt-[65px] mt-[45px] relative">
    <div class="xl:w-[60%] lg:w-[70%] min-[751px]:w-[80%] mx-auto">
        ...
        <div class="flex justify-center mt-[60px] max-[750px]:mt-[50px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/LINE_ALBUM_210916_260.png">
        </div>
    </div>
...
<!-- Thrid Slider -->
<div class="mt-[40px] mx-auto relative overflow-hidden min-[751px]:pb-[157px]">
    ...
    <div class="team_02_slider-full row mt-[30px]">
        ...
        <div class="news-slide mb-[5px] bg-white">
            <div class="relative">
                <img class="w-full" src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/new2.png">
                <div class="absolute top-0 w-full h-full">
                    <div class="relative w-full h-full flex justify-center items-center">
                        <div class="leading-[18px]">
                            <span class='noto-sans text-white px-[20px] bg-[black] text-[10px] font-bold py-[8px]'>ご支給ください</span>
        ...
        <div class="news-slide mb-[5px] bg-white">
            <div class="relative">
                <img class="w-full" src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/new3.png">
                <div class="absolute top-0 w-full h-full">
                    <div class="relative w-full h-full flex justify-center items-center">
                        <div class="leading-[18px]">
                            <span class='noto-sans text-white px-[20px] bg-[black] text-[10px] font-bold py-[8px]'>ご支給ください</span>
        ...
        <div class="news-slide mb-[5px] bg-white">
            <div class="relative">
                <img class="w-full" src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/new4.png">
                <div class="absolute top-0 w-full h-full">
                    <div class="relative w-full h-full flex justify-center items-center">
                        <div class="leading-[18px]">
                            <span class='noto-sans text-white px-[20px] bg-[black] text-[10px] font-bold py-[8px]'>ご支給ください</span>
        ...
        <div class="news-slide mb-[5px] bg-white">
            <div class="relative">
                <img class="w-full" src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/new5.png">
                <div class="absolute top-0 w-full h-full">
                    <div class="relative w-full h-full flex justify-center items-center">
                        <div class="leading-[18px]">
                            <span class='noto-sans text-white px-[20px] bg-[black] text-[10px] font-bold py-[8px]'>ご支給ください</span>
        ...
        <div class="news-slide mb-[5px] bg-white">
            <div class="relative">
                <img class="w-full" src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/new6.png">
                <div class="absolute top-0 w-full h-full">
                    <div class="relative w-full h-full flex justify-center items-center">
                        <div class="leading-[18px]">
                            <span class='noto-sans text-white px-[20px] bg-[black] text-[10px] font-bold py-[8px]'>ご支給ください</span>
...
<!-- Second COntent -->
<div class="relative">   
    <div class="w-full mt-[100px] max-[750px]:mt-[90px] relative min-[751px]:flex min-[751px]:flex-row-reverse overflow-hidden">
        ...
        <div class="smin-750:w-[50%] min-[751px]:10 min-[751px]:ml-[40px]">
            <div class="relative max-[750px]:overflow-hidden">
                <img class="w-full" src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/Group 9401.png">
            </div>
        </div>
            ...
            <div>
                <div class="min-[751px]:float-right 2xl:w-[50%] xl:w-[70%] min-[751px]:w-[90%] max-[750px]:w-full max-[750px]:px-5 max-[750px]:mt-[60px]">
                    ...
                    <p class="font-medium noto-sans min-[1200px]:leading-[28px] min-[751px]:leading-[20px] leading-[48px] tracking-[2px] lg:text-[14px] min-[751px]:text-[12px] text-[24px]">
                        日体大ＳＭＧ横浜の母体となる日本体育大学学友会サッカー部女子は、1985年に創部され、35年を超える歴史の中で、全日本大学選手権大会では29回開催のうち18回の優勝を記録し、多くの日本を代表する女子サッカー選手を輩出して参りました。日本体育大学 横浜･健志台キャンパス（横浜市青葉区鴨志田町）を活動拠点とし、「強く・逞しく・美しく」をスローガンとして研鑽を重ねています。2015シーズンのなでしこリーグ2部参入を機に、日本体育大学学友会サッカー部女子を内包する地域のクラブチームへと進化し始めました。
                    </p>
                </div>
            </div>
        </div>
...
<div class="mt-[140px] max-[750px]:mt-[120px]">
    <div class="image-slider w-full">
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image1.png" class="w-full h-auto border"alt ="slide1">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image2.png" class="w-full h-auto border" alt ="slide2">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image3.png" class="w-full h-auto border" alt ="slide3">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image4.png" class="w-full h-auto border"alt ="slide4">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image5.png" class="w-full h-auto border"alt ="slide4">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image6.png" class="w-full h-auto border"alt ="slide4">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image7.png" class="w-full h-auto border"alt ="slide4">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image8.png" class="w-full h-auto border"alt ="slide4">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image9.png" class="w-full h-auto border"alt ="slide4">
        </div>
        <div class="w-[384px] h-[360px]">
            <img src=" <?= site_url('/wp-content/themes/smg') ?>/assets/images/team_03/image10.png" class="w-full h-auto border"alt ="slide4">
        </div>
    </div>
</div>
