...
<header id='header' class="fixed w-full top-[32px] bg-white z-[1]">
        <nav class="w-full flex flex-row smin-750:shadow-md">
            ...
            <div class="flex flex-row max-lg:h-20 max-smin-750:hidden w-[43%]">
                <div class="nav-link text-[#004EA1] w-3/12 xl:py-4 smin-750:p-2 flex justify-center text-center items-center"> <h3 class="nav-title">競技・試合結果</h3></div>
                <div class="nav-link text-[#004EA1] w-3/12 xl:py-4 smin-750:p-2 flex justify-center text-center items-center"> <h3 class="nav-title">地域活動・<p>プロジェクト</p></h3></div>
                <div class="nav-link text-[#004EA1] w-3/12 xl:py-4 smin-750:p-2 flex justify-center text-center items-center"> <h3 class="nav-title">サポーターズクラブ<p>BLUES</p></h3></div>
                <div class="nav-link text-[#004EA1] w-3/12 xl:py-4 smin-750:p-2 flex justify-center text-center items-center"> <h3 class="nav-title"><p>BLUES</p>オンラインショップ</h3></div>
            </div>
